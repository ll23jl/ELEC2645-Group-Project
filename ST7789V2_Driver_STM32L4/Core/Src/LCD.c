...
static const uint16_t palette_custom[16] = {
    RGB565_BLACK, CAT_DARK_GREEN, CAT_LIGHT_GREEN, CAT_DARK_BLUE,
    CAT_MED_BLUE, CAT_LIGHT_BLUE, CAT_PINK, RGB565_GREY_7,
    RGB565_WHITE, RGB565_SKY_BLUE, RGB565_CYAN, RGB565_VINTAGE_6,
